...
.card-contact-container{
     position: relative;
     background: rgb(30, 0, 32);
      width: 30vw;
      height: 40vw;
      margin: -15vw auto;
      border-radius: 15px;
      box-shadow: 0 0 15px #ff1bce;
       @include for-800 {    
          width: 50vw;
        height: 60vw;
        }
...
.feedback-input:focus { border:2px solid #ff1bce; }
...
[type="submit"]:hover { background:#ff1bce; }
